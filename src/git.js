...
// Permite que exec tenga una promesa
...
export async function getChangedFiles () {
  // --porcelain permite que sea más facil de interpretar por una maquina
  // stdout recupera la respuesta de git status --porcelain
  // stderr retorna error de la ejecución del comando git status --porcelain
